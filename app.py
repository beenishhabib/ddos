...
f = ['src_bytes', 'count', 'service', 'dst_bytes','dst_host_same_src_port_rate', 'srv_count', 'dst_host_count','protocol_type', 'dst_host_srv_diff_host_rate', 'dst_host_srv_count']
